...
namespace signals {
    ...
    struct signal {
        ...
        template<typename T>
        connection connect(T* obj, void (T::*method)()) {
            assert(obj);
            assert(method);
            return connect([=](ARG1 arg1) { (obj->*method)(); });
        }

        template<typename T, typename ARG1>
        connection connect(T* obj, void (T::*method)(ARG1 arg1)) {
            assert(obj);
            assert(method);
        ...
        connection connect(T* obj, void (T::*method)(ARG1 arg1, ARG2 arg2)) {
            assert(obj);
            assert(method);
        ...
        connection connect(T* obj, void (T::*method)(ARG1 arg1, ARG2 arg2, ARG3 arg3)) {
            assert(obj);
            assert(method);
